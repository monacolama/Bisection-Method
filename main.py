...
def bisection(function, range, error):
    ...
    while resultOfFunction > float(error) or resultOfFunction < float(-error):
        ...
        x = (float(range[0]) + float(range[1])) / 2
...
def menu():
    while True:
        ...
        functionUser = input("\n Write a function: ")
        a = input(" Write the first value of the range: ")
        b = input(" Write the second value of the range: ")
        errorUser = float(input(" Write the error value: "))
        print("\n")
